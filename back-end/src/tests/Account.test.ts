...
const token2 = 'eyJhbG11ciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6OTk5LCJ1c2VybmFtZSI6IkNyaXN0aWFub1YiLCJpYXQiOjE2NjkxMTY3NDQsImV4cCI6MTY2OTIwMzE0NH0.wOSWpMNA5BMrPAVLxFo4Tts2hbq2odBwj2SYVuyMDTw';
...
describe('Testando rota de Account', () => {
  describe('Sucesso', () => {
    ...
    it('Testando Account com tudo correto', async () => {
      // Sinon.stub(JwtSecret, 'verify').resolves(token as any);
